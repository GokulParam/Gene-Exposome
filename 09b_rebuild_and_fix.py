...
n_before = len(master)
# Exclude known non-continental zip3s AND anyone with no zip3 (NaN → "nan")
exclude_mask = zip3_key.isin(EXCLUDE_ZIP3) | master['zip3'].isna()
master = master[~exclude_mask].copy()
